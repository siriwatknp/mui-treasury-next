...
<Meta title="Layout/Core Concept" />
...
```js
import { Root, getStandardScheme } from "@mui-treasury/layout";
...
- [Dashboard Layout](/?path=/docs/layout-tutorials-dashboard--page)
- [Blog Layout](/?path=/docs/layout-tutorials-blog--page)
